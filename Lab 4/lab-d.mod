...
var termin_rozpoczecia_min {ZADANIA} >= 0 integer;
var termin_rozpoczecia_max {ZADANIA} >= 0 integer;
var czas_trwania {ZADANIA} >= 0 integer;

var skrocony_czas {ZADANIA} >= 0;

var zapas {ZADANIA} >= 0 integer;

var jednostek {ZADANIA} >= 0 integer;
